...
(function () {
    ...
    function nodeService($http) {
        ...
        var service = {
            ...
            getPaths: getPaths,
            loadNodesInfo: loadNodesInfo,

            getContentIds: getContentIds,
            getNodesFromList: getNodesFromList,
        ...
        function getNodesFromList(nodes) {
            return $http.post(serviceRoot + 'GetNodesFromList', nodes);
        }
        ...
        function loadNodesInfo(nodes) {
            return $http.post(serviceRoot + "LoadNodesInfo", nodes);
