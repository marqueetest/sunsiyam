        ...
        function loadItem(id) {
            ...
            translateNodeService.getNode(id)
                .then(function (result) {
                    ...
                    if (!vm.item.IsDictionary) {
                        contentResource.getById(vm.item.TargetNodeId)
                            .then(function (content) {
                                vm.targetUrl = _.find(content.urls, function (url) { return url.culture == vm.item.Culture.Name; })
                                if (vm.targetUrl === undefined) {
                                    vm.targetUrl = { text: '/' + vm.item.TargetNodeId }
                                }
                            });
                    }
